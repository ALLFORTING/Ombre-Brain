...
todos: 只提取原文中明确表达、尚未完成的具体行动事项。明确排除原则/规则、偏好、建议、推测、假设性行动以及模型自行推断出的任务；没有符合要求的行动事项就返回空数组，不要创造任务
...
6. todos（未完成待办）：只提取原文中明确表达、尚未完成的具体行动事项。明确排除原则/规则、偏好、建议、推测、假设性行动以及模型自行推断出的任务；没有符合要求的行动事项就返回空数组，不要创造任务
