...
NON_PATH_CALL_ALLOWLIST: dict[tuple[str, str, int, str], str] = {
    ...
    ("server.py", "breath_hook", 1056, "bucket_mgr.touch"): "incidental_bucket_activation",
    ("server.py", "dream_hook", 1104, "bucket_mgr.touch"): "incidental_bucket_activation",
    ...
    ("server.py", "_dream_summary_line", 1238, "replace"): "string_formatting",
    ("server.py", "_normalize_todos", 1504, "text.replace"): "string_normalization",
    ("server.py", "_days_since", 1938, "dt.replace"): "datetime_timezone",
    ("server.py", "format_active_matches", 2635, "bucket_mgr.touch"): "incidental_bucket_activation",
    ("server.py", "_breath_impl", 2988, "bucket_mgr.touch"): "incidental_bucket_activation",
    ("server.py", "_breath_impl", 3022, "bucket_mgr.touch"): "incidental_bucket_activation",
    ("server.py", "_breath_impl", 3088, "bucket_mgr.touch"): "incidental_bucket_activation",
    ("server.py", "_compose_breath_query_matches", 2766, "bucket_mgr.touch"): "incidental_bucket_activation",
    ("server.py", "_attachment_probe_scan", 3370, "replace"): "string_normalization",
    ("server.py", "_rm_verified_view_image", 4458, "Image.open"): "pillow_image_read",
    ("server.py", "hold", 6196, "replace"): "string_normalization",
    ("server.py", "boot", 6819, "replace"): "string_normalization",
    ("server.py", "dream", 7051, "bucket_mgr.touch"): "incidental_bucket_activation",
    ("server.py", "dream", 7077, "bucket_mgr.touch"): "incidental_bucket_activation",
