...
NON_PATH_CALL_ALLOWLIST: dict[tuple[str, str, int, str], str] = {
    ...
    ("server.py", "_dream_summary_line", 1196, "replace"): "string_formatting",
    ("server.py", "_normalize_todos", 1462, "text.replace"): "string_normalization",
    ("server.py", "_days_since", 1800, "dt.replace"): "datetime_timezone",
    ("server.py", "format_active_matches", 2448, "bucket_mgr.touch"): "incidental_bucket_activation",
    ("server.py", "_breath_impl", 2771, "bucket_mgr.touch"): "incidental_bucket_activation",
    ("server.py", "_breath_impl", 2805, "bucket_mgr.touch"): "incidental_bucket_activation",
    ("server.py", "_breath_impl", 2871, "bucket_mgr.touch"): "incidental_bucket_activation",
    ("server.py", "_compose_breath_query_matches", 2565, "bucket_mgr.touch"): "incidental_bucket_activation",
    ("server.py", "_attachment_probe_scan", 3151, "replace"): "string_normalization",
    ("server.py", "_rm_verified_view_image", 4239, "Image.open"): "pillow_image_read",
    ("server.py", "hold", 5977, "replace"): "string_normalization",
    ("server.py", "boot", 6553, "replace"): "string_normalization",
    ("server.py", "dream", 6755, "bucket_mgr.touch"): "incidental_bucket_activation",
    ("server.py", "dream", 6781, "bucket_mgr.touch"): "incidental_bucket_activation",
