...
NON_PATH_CALL_ALLOWLIST: dict[tuple[str, str, int, str], str] = {
    ...
    ("server.py", "_dream_summary_line", 1188, "replace"): "string_formatting",
    ("server.py", "_normalize_todos", 1401, "text.replace"): "string_normalization",
    ("server.py", "_days_since", 1712, "dt.replace"): "datetime_timezone",
    ("server.py", "format_active_matches", 2379, "bucket_mgr.touch"): "incidental_bucket_activation",
    ("server.py", "_breath_impl", 2604, "bucket_mgr.touch"): "incidental_bucket_activation",
    ("server.py", "_breath_impl", 2638, "bucket_mgr.touch"): "incidental_bucket_activation",
    ("server.py", "_breath_impl", 2704, "bucket_mgr.touch"): "incidental_bucket_activation",
    ("server.py", "_breath_impl", 2845, "bucket_mgr.touch"): "incidental_bucket_activation",
    ("server.py", "_attachment_probe_scan", 2995, "replace"): "string_normalization",
    ("server.py", "_rm_verified_view_image", 4083, "Image.open"): "pillow_image_read",
    ("server.py", "hold", 5798, "replace"): "string_normalization",
    ("server.py", "boot", 6342, "replace"): "string_normalization",
    ("server.py", "dream", 6544, "bucket_mgr.touch"): "incidental_bucket_activation",
    ("server.py", "dream", 6570, "bucket_mgr.touch"): "incidental_bucket_activation",
