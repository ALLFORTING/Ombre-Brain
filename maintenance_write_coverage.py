...
NON_PATH_CALL_ALLOWLIST: dict[tuple[str, str, int, str], str] = {
    ...
    ("server.py", "breath_hook", 1049, "bucket_mgr.touch"): "incidental_bucket_activation",
    ("server.py", "dream_hook", 1097, "bucket_mgr.touch"): "incidental_bucket_activation",
    ...
    ("server.py", "_dream_summary_line", 1231, "replace"): "string_formatting",
    ("server.py", "_normalize_todos", 1497, "text.replace"): "string_normalization",
    ("server.py", "_days_since", 1843, "dt.replace"): "datetime_timezone",
    ("server.py", "format_active_matches", 2491, "bucket_mgr.touch"): "incidental_bucket_activation",
    ("server.py", "_breath_impl", 2814, "bucket_mgr.touch"): "incidental_bucket_activation",
    ("server.py", "_breath_impl", 2848, "bucket_mgr.touch"): "incidental_bucket_activation",
    ("server.py", "_breath_impl", 2914, "bucket_mgr.touch"): "incidental_bucket_activation",
    ("server.py", "_compose_breath_query_matches", 2608, "bucket_mgr.touch"): "incidental_bucket_activation",
    ("server.py", "_attachment_probe_scan", 3194, "replace"): "string_normalization",
    ("server.py", "_rm_verified_view_image", 4282, "Image.open"): "pillow_image_read",
    ("server.py", "hold", 6020, "replace"): "string_normalization",
    ("server.py", "boot", 6640, "replace"): "string_normalization",
    ("server.py", "dream", 6871, "bucket_mgr.touch"): "incidental_bucket_activation",
    ("server.py", "dream", 6897, "bucket_mgr.touch"): "incidental_bucket_activation",
