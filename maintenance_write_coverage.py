...
NON_PATH_CALL_ALLOWLIST: dict[tuple[str, str, int, str], str] = {
    ...
    ("server.py", "breath_hook", 999, "bucket_mgr.touch"): "incidental_bucket_activation",
    ("server.py", "dream_hook", 1047, "bucket_mgr.touch"): "incidental_bucket_activation",
    ("server.py", "_dream_summary_line", 1173, "replace"): "string_formatting",
    ("server.py", "_normalize_todos", 1301, "text.replace"): "string_normalization",
    ("server.py", "_days_since", 1612, "dt.replace"): "datetime_timezone",
    ("server.py", "_breath_impl", 2203, "bucket_mgr.touch"): "incidental_bucket_activation",
    ("server.py", "_breath_impl", 2237, "bucket_mgr.touch"): "incidental_bucket_activation",
    ("server.py", "_breath_impl", 2303, "bucket_mgr.touch"): "incidental_bucket_activation",
    ("server.py", "_breath_impl", 2444, "bucket_mgr.touch"): "incidental_bucket_activation",
    ("server.py", "_attachment_probe_scan", 2585, "replace"): "string_normalization",
    ("server.py", "_rm_verified_view_image", 3673, "Image.open"): "pillow_image_read",
    ("server.py", "hold", 4927, "replace"): "string_normalization",
    ("server.py", "boot", 5450, "replace"): "string_normalization",
    ("server.py", "dream", 5652, "bucket_mgr.touch"): "incidental_bucket_activation",
    ("server.py", "dream", 5678, "bucket_mgr.touch"): "incidental_bucket_activation",
