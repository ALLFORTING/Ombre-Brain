...
NON_PATH_CALL_ALLOWLIST: dict[tuple[str, str, int, str], str] = {
    ...
    ("server.py", "breath_hook", 1060, "bucket_mgr.touch"): "incidental_bucket_activation",
    ("server.py", "dream_hook", 1108, "bucket_mgr.touch"): "incidental_bucket_activation",
    ...
    ("server.py", "_dream_summary_line", 1242, "replace"): "string_formatting",
    ("server.py", "_normalize_todos", 1508, "text.replace"): "string_normalization",
    ("server.py", "_days_since", 1942, "dt.replace"): "datetime_timezone",
    ("server.py", "format_active_matches", 2708, "bucket_mgr.touch"): "incidental_bucket_activation_or_explicit_dormant_wake",
    ("server.py", "_breath_impl", 3154, "bucket_mgr.touch"): "incidental_bucket_activation_or_explicit_dormant_wake",
    ("server.py", "_breath_impl", 3191, "bucket_mgr.touch"): "incidental_bucket_activation_or_explicit_dormant_wake",
    ("server.py", "_breath_impl", 3260, "bucket_mgr.touch"): "incidental_bucket_activation_or_explicit_dormant_wake",
    ("server.py", "_compose_breath_query_matches", 2922, "bucket_mgr.touch"): "incidental_bucket_activation_or_explicit_dormant_wake",
    ("server.py", "_attachment_probe_scan", 3592, "replace"): "string_normalization",
    ("server.py", "_rm_verified_view_image", 4680, "Image.open"): "pillow_image_read",
    ("server.py", "hold", 6454, "replace"): "string_normalization",
    ("server.py", "boot", 7075, "replace"): "string_normalization",
    ("server.py", "dream", 7307, "bucket_mgr.touch"): "incidental_bucket_activation_or_explicit_dormant_wake",
    ("server.py", "dream", 7336, "bucket_mgr.touch"): "incidental_bucket_activation_or_explicit_dormant_wake",
