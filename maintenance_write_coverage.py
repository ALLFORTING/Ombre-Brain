...
NON_PATH_CALL_ALLOWLIST: dict[tuple[str, str, int, str], str] = {
    ...
    ("server.py", "_normalize_todos", 1454, "text.replace"): "string_normalization",
    ("server.py", "_days_since", 1765, "dt.replace"): "datetime_timezone",
    ("server.py", "format_active_matches", 2413, "bucket_mgr.touch"): "incidental_bucket_activation",
    ("server.py", "_breath_impl", 2736, "bucket_mgr.touch"): "incidental_bucket_activation",
    ("server.py", "_breath_impl", 2770, "bucket_mgr.touch"): "incidental_bucket_activation",
    ("server.py", "_breath_impl", 2836, "bucket_mgr.touch"): "incidental_bucket_activation",
    ...
    ("server.py", "boot", 6484, "replace"): "string_normalization",
    ("server.py", "dream", 6686, "bucket_mgr.touch"): "incidental_bucket_activation",
    ("server.py", "dream", 6712, "bucket_mgr.touch"): "incidental_bucket_activation",
