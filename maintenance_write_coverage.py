...
NON_PATH_CALL_ALLOWLIST: dict[tuple[str, str, int, str], str] = {
    ...
    ("server.py", "boot", 7077, "replace"): "string_normalization",
    ("server.py", "dream", 7309, "bucket_mgr.touch"): "incidental_bucket_activation_or_explicit_dormant_wake",
    ("server.py", "dream", 7338, "bucket_mgr.touch"): "incidental_bucket_activation_or_explicit_dormant_wake",
