...
NON_PATH_CALL_ALLOWLIST: dict[tuple[str, str, int, str], str] = {
    ...
    ("server.py", "breath_hook", 1061, "bucket_mgr.touch"): "incidental_bucket_activation",
    ("server.py", "dream_hook", 1109, "bucket_mgr.touch"): "incidental_bucket_activation",
    ...
    ("server.py", "_dream_summary_line", 1318, "replace"): "string_formatting",
    ("server.py", "_normalize_todos", 1584, "text.replace"): "string_normalization",
    ("server.py", "_days_since", 2210, "dt.replace"): "datetime_timezone",
    ("server.py", "format_active_matches", 2987, "bucket_mgr.touch"): "incidental_bucket_activation_or_explicit_dormant_wake",
    ("server.py", "_breath_impl", 3614, "bucket_mgr.touch"): "incidental_bucket_activation_or_explicit_dormant_wake",
    ("server.py", "_breath_impl", 3651, "bucket_mgr.touch"): "incidental_bucket_activation_or_explicit_dormant_wake",
    ("server.py", "_breath_impl", 3720, "bucket_mgr.touch"): "incidental_bucket_activation_or_explicit_dormant_wake",
    ("server.py", "_compose_breath_query_matches", 3361, "bucket_mgr.touch"): "incidental_bucket_activation_or_explicit_dormant_wake",
    ("server.py", "_attachment_probe_scan", 4087, "replace"): "string_normalization",
    ("server.py", "_rm_verified_view_image", 5175, "Image.open"): "pillow_image_read",
    ("server.py", "hold", 6951, "replace"): "string_normalization",
    ("server.py", "boot", 7626, "replace"): "string_normalization",
    ("server.py", "dream", 7862, "bucket_mgr.touch"): "incidental_bucket_activation_or_explicit_dormant_wake",
    ("server.py", "dream", 7891, "bucket_mgr.touch"): "incidental_bucket_activation_or_explicit_dormant_wake",
