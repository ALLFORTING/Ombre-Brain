...
NON_PATH_CALL_ALLOWLIST: dict[tuple[str, str, int, str], str] = {
    ...
    ("server.py", "format_active_matches", 2492, "bucket_mgr.touch"): "incidental_bucket_activation",
    ("server.py", "_breath_impl", 2822, "bucket_mgr.touch"): "incidental_bucket_activation",
    ("server.py", "_breath_impl", 2859, "bucket_mgr.touch"): "incidental_bucket_activation",
    ("server.py", "_breath_impl", 2928, "bucket_mgr.touch"): "incidental_bucket_activation",
    ("server.py", "_compose_breath_query_matches", 2611, "bucket_mgr.touch"): "incidental_bucket_activation",
    ("server.py", "_attachment_probe_scan", 3212, "replace"): "string_normalization",
    ("server.py", "_rm_verified_view_image", 4300, "Image.open"): "pillow_image_read",
    ("server.py", "hold", 6040, "replace"): "string_normalization",
    ("server.py", "boot", 6660, "replace"): "string_normalization",
    ("server.py", "dream", 6891, "bucket_mgr.touch"): "incidental_bucket_activation",
    ("server.py", "dream", 6920, "bucket_mgr.touch"): "incidental_bucket_activation",
