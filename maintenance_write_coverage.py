...
NON_PATH_CALL_ALLOWLIST: dict[tuple[str, str, int, str], str] = {
    ...
    ("server.py", "boot", 6597, "replace"): "string_normalization",
    ("server.py", "dream", 6828, "bucket_mgr.touch"): "incidental_bucket_activation",
    ("server.py", "dream", 6854, "bucket_mgr.touch"): "incidental_bucket_activation",
