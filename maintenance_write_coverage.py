...
NON_PATH_CALL_ALLOWLIST: dict[tuple[str, str, int, str], str] = {
    ...
    ("server.py", "_dream_summary_line", 1243, "replace"): "string_formatting",
    ("server.py", "_normalize_todos", 1509, "text.replace"): "string_normalization",
    ("server.py", "_days_since", 1943, "dt.replace"): "datetime_timezone",
    ("server.py", "format_active_matches", 2720, "bucket_mgr.touch"): "incidental_bucket_activation_or_explicit_dormant_wake",
    ("server.py", "_breath_impl", 3338, "bucket_mgr.touch"): "incidental_bucket_activation_or_explicit_dormant_wake",
    ("server.py", "_breath_impl", 3375, "bucket_mgr.touch"): "incidental_bucket_activation_or_explicit_dormant_wake",
    ("server.py", "_breath_impl", 3444, "bucket_mgr.touch"): "incidental_bucket_activation_or_explicit_dormant_wake",
    ("server.py", "_compose_breath_query_matches", 3092, "bucket_mgr.touch"): "incidental_bucket_activation_or_explicit_dormant_wake",
    ("server.py", "_attachment_probe_scan", 3811, "replace"): "string_normalization",
    ("server.py", "_rm_verified_view_image", 4899, "Image.open"): "pillow_image_read",
    ("server.py", "hold", 6675, "replace"): "string_normalization",
    ("server.py", "boot", 7296, "replace"): "string_normalization",
    ("server.py", "dream", 7529, "bucket_mgr.touch"): "incidental_bucket_activation_or_explicit_dormant_wake",
    ("server.py", "dream", 7558, "bucket_mgr.touch"): "incidental_bucket_activation_or_explicit_dormant_wake",
