...
NON_PATH_CALL_ALLOWLIST: dict[tuple[str, str, int, str], str] = {
    ...
    ("server.py", "breath_hook", 1014, "bucket_mgr.touch"): "incidental_bucket_activation",
    ("server.py", "dream_hook", 1062, "bucket_mgr.touch"): "incidental_bucket_activation",
    ("server.py", "_dream_summary_line", 1178, "replace"): "string_formatting",
    ("server.py", "_normalize_todos", 1444, "text.replace"): "string_normalization",
    ("server.py", "_days_since", 1759, "dt.replace"): "datetime_timezone",
    ("server.py", "format_active_matches", 2407, "bucket_mgr.touch"): "incidental_bucket_activation",
    ("server.py", "_breath_impl", 2730, "bucket_mgr.touch"): "incidental_bucket_activation",
    ("server.py", "_breath_impl", 2764, "bucket_mgr.touch"): "incidental_bucket_activation",
    ("server.py", "_breath_impl", 2830, "bucket_mgr.touch"): "incidental_bucket_activation",
    ("server.py", "_compose_breath_query_matches", 2524, "bucket_mgr.touch"): "incidental_bucket_activation",
    ("server.py", "_attachment_probe_scan", 3110, "replace"): "string_normalization",
    ("server.py", "_rm_verified_view_image", 4198, "Image.open"): "pillow_image_read",
    ("server.py", "hold", 5936, "replace"): "string_normalization",
    ("server.py", "boot", 6497, "replace"): "string_normalization",
    ("server.py", "dream", 6699, "bucket_mgr.touch"): "incidental_bucket_activation",
    ("server.py", "dream", 6725, "bucket_mgr.touch"): "incidental_bucket_activation",
