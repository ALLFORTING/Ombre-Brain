...
NON_PATH_CALL_ALLOWLIST: dict[tuple[str, str, int, str], str] = {
    ...
    ("server.py", "_normalize_todos", 1393, "text.replace"): "string_normalization",
    ("server.py", "_days_since", 1704, "dt.replace"): "datetime_timezone",
    ("server.py", "format_active_matches", 2371, "bucket_mgr.touch"): "incidental_bucket_activation",
    ("server.py", "_breath_impl", 2596, "bucket_mgr.touch"): "incidental_bucket_activation",
    ("server.py", "_breath_impl", 2630, "bucket_mgr.touch"): "incidental_bucket_activation",
    ("server.py", "_breath_impl", 2696, "bucket_mgr.touch"): "incidental_bucket_activation",
    ("server.py", "_breath_impl", 2837, "bucket_mgr.touch"): "incidental_bucket_activation",
    ("server.py", "_attachment_probe_scan", 2978, "replace"): "string_normalization",
    ("server.py", "_rm_verified_view_image", 4066, "Image.open"): "pillow_image_read",
    ("server.py", "hold", 5335, "replace"): "string_normalization",
    ("server.py", "boot", 5879, "replace"): "string_normalization",
    ("server.py", "dream", 6081, "bucket_mgr.touch"): "incidental_bucket_activation",
    ("server.py", "dream", 6107, "bucket_mgr.touch"): "incidental_bucket_activation",
