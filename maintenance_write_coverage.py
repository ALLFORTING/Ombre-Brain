...
NON_PATH_CALL_ALLOWLIST: dict[tuple[str, str, int, str], str] = {
    ...
    ("server.py", "breath_hook", 1059, "bucket_mgr.touch"): "incidental_bucket_activation",
    ("server.py", "dream_hook", 1107, "bucket_mgr.touch"): "incidental_bucket_activation",
    ...
    ("server.py", "_dream_summary_line", 1241, "replace"): "string_formatting",
    ("server.py", "_normalize_todos", 1507, "text.replace"): "string_normalization",
    ("server.py", "_days_since", 1941, "dt.replace"): "datetime_timezone",
    ("server.py", "format_active_matches", 2691, "bucket_mgr.touch"): "incidental_bucket_activation_or_explicit_dormant_wake",
    ("server.py", "_breath_impl", 3137, "bucket_mgr.touch"): "incidental_bucket_activation_or_explicit_dormant_wake",
    ("server.py", "_breath_impl", 3174, "bucket_mgr.touch"): "incidental_bucket_activation_or_explicit_dormant_wake",
    ("server.py", "_breath_impl", 3243, "bucket_mgr.touch"): "incidental_bucket_activation_or_explicit_dormant_wake",
    ("server.py", "_compose_breath_query_matches", 2905, "bucket_mgr.touch"): "incidental_bucket_activation_or_explicit_dormant_wake",
    ("server.py", "_attachment_probe_scan", 3575, "replace"): "string_normalization",
    ("server.py", "_rm_verified_view_image", 4663, "Image.open"): "pillow_image_read",
    ("server.py", "hold", 6421, "replace"): "string_normalization",
    ("server.py", "boot", 7044, "replace"): "string_normalization",
    ("server.py", "dream", 7276, "bucket_mgr.touch"): "incidental_bucket_activation_or_explicit_dormant_wake",
    ("server.py", "dream", 7305, "bucket_mgr.touch"): "incidental_bucket_activation_or_explicit_dormant_wake",
