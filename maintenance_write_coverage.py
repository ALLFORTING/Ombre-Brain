...
NON_PATH_CALL_ALLOWLIST: dict[tuple[str, str, int, str], str] = {
    ...
    ("server.py", "_days_since", 1923, "dt.replace"): "datetime_timezone",
    ("server.py", "format_active_matches", 2620, "bucket_mgr.touch"): "incidental_bucket_activation",
    ("server.py", "_breath_impl", 2973, "bucket_mgr.touch"): "incidental_bucket_activation",
    ("server.py", "_breath_impl", 3007, "bucket_mgr.touch"): "incidental_bucket_activation",
    ("server.py", "_breath_impl", 3073, "bucket_mgr.touch"): "incidental_bucket_activation",
    ("server.py", "_compose_breath_query_matches", 2751, "bucket_mgr.touch"): "incidental_bucket_activation",
    ("server.py", "_attachment_probe_scan", 3355, "replace"): "string_normalization",
    ("server.py", "_rm_verified_view_image", 4443, "Image.open"): "pillow_image_read",
    ("server.py", "hold", 6181, "replace"): "string_normalization",
    ("server.py", "boot", 6801, "replace"): "string_normalization",
    ("server.py", "dream", 7033, "bucket_mgr.touch"): "incidental_bucket_activation",
    ("server.py", "dream", 7059, "bucket_mgr.touch"): "incidental_bucket_activation",
