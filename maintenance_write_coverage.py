...
NON_PATH_CALL_ALLOWLIST: dict[tuple[str, str, int, str], str] = {
    ...
    ("server.py", "format_active_matches", 2707, "bucket_mgr.touch"): "incidental_bucket_activation_or_explicit_dormant_wake",
    ("server.py", "_breath_impl", 3153, "bucket_mgr.touch"): "incidental_bucket_activation_or_explicit_dormant_wake",
    ("server.py", "_breath_impl", 3190, "bucket_mgr.touch"): "incidental_bucket_activation_or_explicit_dormant_wake",
    ("server.py", "_breath_impl", 3259, "bucket_mgr.touch"): "incidental_bucket_activation_or_explicit_dormant_wake",
    ("server.py", "_compose_breath_query_matches", 2921, "bucket_mgr.touch"): "incidental_bucket_activation_or_explicit_dormant_wake",
    ("server.py", "_attachment_probe_scan", 3591, "replace"): "string_normalization",
    ("server.py", "_rm_verified_view_image", 4679, "Image.open"): "pillow_image_read",
    ("server.py", "hold", 6452, "replace"): "string_normalization",
