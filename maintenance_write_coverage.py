...
NON_PATH_CALL_ALLOWLIST: dict[tuple[str, str, int, str], str] = {
    ...
    ("server.py", "breath_hook", 834, "bucket_mgr.touch"): "incidental_bucket_activation",
    ("server.py", "dream_hook", 882, "bucket_mgr.touch"): "incidental_bucket_activation",
    ("server.py", "_dream_summary_line", 1008, "replace"): "string_formatting",
    ("server.py", "_normalize_todos", 1136, "text.replace"): "string_normalization",
    ("server.py", "_days_since", 1447, "dt.replace"): "datetime_timezone",
    ("server.py", "_breath_impl", 2038, "bucket_mgr.touch"): "incidental_bucket_activation",
    ("server.py", "_breath_impl", 2072, "bucket_mgr.touch"): "incidental_bucket_activation",
    ("server.py", "_breath_impl", 2138, "bucket_mgr.touch"): "incidental_bucket_activation",
    ("server.py", "_breath_impl", 2279, "bucket_mgr.touch"): "incidental_bucket_activation",
    ("server.py", "_attachment_probe_scan", 2420, "replace"): "string_normalization",
    ("server.py", "_rm_verified_view_image", 3508, "Image.open"): "pillow_image_read",
    ("server.py", "hold", 4762, "replace"): "string_normalization",
    ("server.py", "boot", 5285, "replace"): "string_normalization",
    ("server.py", "dream", 5487, "bucket_mgr.touch"): "incidental_bucket_activation",
    ("server.py", "dream", 5513, "bucket_mgr.touch"): "incidental_bucket_activation",
