...
NON_PATH_CALL_ALLOWLIST: dict[tuple[str, str, int, str], str] = {
    ...
    ("server.py", "breath_hook", 705, "bucket_mgr.touch"): "incidental_bucket_activation",
    ("server.py", "dream_hook", 753, "bucket_mgr.touch"): "incidental_bucket_activation",
    ("server.py", "_dream_summary_line", 879, "replace"): "string_formatting",
    ("server.py", "_normalize_todos", 1007, "text.replace"): "string_normalization",
    ("server.py", "_days_since", 1318, "dt.replace"): "datetime_timezone",
    ("server.py", "_breath_impl", 1909, "bucket_mgr.touch"): "incidental_bucket_activation",
    ("server.py", "_breath_impl", 1943, "bucket_mgr.touch"): "incidental_bucket_activation",
    ("server.py", "_breath_impl", 2009, "bucket_mgr.touch"): "incidental_bucket_activation",
    ("server.py", "_breath_impl", 2150, "bucket_mgr.touch"): "incidental_bucket_activation",
    ("server.py", "_attachment_probe_scan", 2291, "replace"): "string_normalization",
    ("server.py", "_rm_verified_view_image", 3379, "Image.open"): "pillow_image_read",
    ("server.py", "hold", 4633, "replace"): "string_normalization",
    ("server.py", "boot", 5156, "replace"): "string_normalization",
    ("server.py", "dream", 5358, "bucket_mgr.touch"): "incidental_bucket_activation",
    ("server.py", "dream", 5384, "bucket_mgr.touch"): "incidental_bucket_activation",
