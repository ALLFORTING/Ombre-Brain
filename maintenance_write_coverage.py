...
NON_PATH_CALL_ALLOWLIST: dict[tuple[str, str, int, str], str] = {
    ("asset_dashboard.py", "resolve_image", 489, "Image.open"): "pillow_image_read",
    ...
    ("asset_cutover_state.py", "_now", 402, "value.replace"): "datetime_timezone",
    ("asset_cutover_state.py", "_parse_timestamp", 1712, "parsed.replace"): "datetime_timezone",
    ...
    ("remember_me_core_adapter.py", "_normalize_timestamp", 572, "replace"): "datetime_timezone",
    ("remember_me_core_adapter.py", "_normalize_timestamp", 576, "parsed.replace"): "datetime_timezone",
    ...
    ("server.py", "breath_hook", 1008, "bucket_mgr.touch"): "incidental_bucket_activation",
    ("server.py", "dream_hook", 1056, "bucket_mgr.touch"): "incidental_bucket_activation",
    ("server.py", "_dream_summary_line", 1182, "replace"): "string_formatting",
    ("server.py", "_normalize_todos", 1395, "text.replace"): "string_normalization",
    ("server.py", "_days_since", 1706, "dt.replace"): "datetime_timezone",
    ("server.py", "format_active_matches", 2373, "bucket_mgr.touch"): "incidental_bucket_activation",
    ("server.py", "_breath_impl", 2598, "bucket_mgr.touch"): "incidental_bucket_activation",
    ("server.py", "_breath_impl", 2632, "bucket_mgr.touch"): "incidental_bucket_activation",
    ("server.py", "_breath_impl", 2698, "bucket_mgr.touch"): "incidental_bucket_activation",
    ("server.py", "_breath_impl", 2839, "bucket_mgr.touch"): "incidental_bucket_activation",
    ("server.py", "_attachment_probe_scan", 2989, "replace"): "string_normalization",
    ("server.py", "_rm_verified_view_image", 4077, "Image.open"): "pillow_image_read",
    ("server.py", "hold", 5391, "replace"): "string_normalization",
    ("server.py", "boot", 5935, "replace"): "string_normalization",
