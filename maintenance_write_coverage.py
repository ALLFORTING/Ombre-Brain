...
NON_PATH_CALL_ALLOWLIST: dict[tuple[str, str, int, str], str] = {
    ...
    ("server.py", "_normalize_todos", 1326, "text.replace"): "string_normalization",
    ("server.py", "_days_since", 1637, "dt.replace"): "datetime_timezone",
    ("server.py", "_breath_impl", 2228, "bucket_mgr.touch"): "incidental_bucket_activation",
    ("server.py", "_breath_impl", 2262, "bucket_mgr.touch"): "incidental_bucket_activation",
    ("server.py", "_breath_impl", 2328, "bucket_mgr.touch"): "incidental_bucket_activation",
    ("server.py", "_breath_impl", 2469, "bucket_mgr.touch"): "incidental_bucket_activation",
    ("server.py", "_attachment_probe_scan", 2610, "replace"): "string_normalization",
    ("server.py", "_rm_verified_view_image", 3698, "Image.open"): "pillow_image_read",
    ("server.py", "hold", 4952, "replace"): "string_normalization",
    ("server.py", "boot", 5496, "replace"): "string_normalization",
    ("server.py", "dream", 5698, "bucket_mgr.touch"): "incidental_bucket_activation",
    ("server.py", "dream", 5724, "bucket_mgr.touch"): "incidental_bucket_activation",
