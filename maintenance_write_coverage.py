...
NON_PATH_CALL_ALLOWLIST: dict[tuple[str, str, int, str], str] = {
    ...
    ("server.py", "format_active_matches", 2690, "bucket_mgr.touch"): "incidental_bucket_activation",
    ("server.py", "_breath_impl", 3129, "bucket_mgr.touch"): "incidental_bucket_activation",
    ("server.py", "_breath_impl", 3163, "bucket_mgr.touch"): "incidental_bucket_activation",
    ("server.py", "_breath_impl", 3229, "bucket_mgr.touch"): "incidental_bucket_activation",
    ("server.py", "_compose_breath_query_matches", 2902, "bucket_mgr.touch"): "incidental_bucket_activation",
    ("server.py", "_attachment_probe_scan", 3557, "replace"): "string_normalization",
    ("server.py", "_rm_verified_view_image", 4645, "Image.open"): "pillow_image_read",
    ("server.py", "hold", 6393, "replace"): "string_normalization",
    ("server.py", "boot", 7016, "replace"): "string_normalization",
    ("server.py", "dream", 7248, "bucket_mgr.touch"): "incidental_bucket_activation",
    ("server.py", "dream", 7274, "bucket_mgr.touch"): "incidental_bucket_activation",
