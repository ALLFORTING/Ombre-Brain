...
NON_PATH_CALL_ALLOWLIST: dict[tuple[str, str, int, str], str] = {
    ...
    ("server.py", "_days_since", 1786, "dt.replace"): "datetime_timezone",
    ("server.py", "format_active_matches", 2434, "bucket_mgr.touch"): "incidental_bucket_activation",
    ("server.py", "_breath_impl", 2757, "bucket_mgr.touch"): "incidental_bucket_activation",
    ("server.py", "_breath_impl", 2791, "bucket_mgr.touch"): "incidental_bucket_activation",
    ("server.py", "_breath_impl", 2857, "bucket_mgr.touch"): "incidental_bucket_activation",
    ("server.py", "_compose_breath_query_matches", 2551, "bucket_mgr.touch"): "incidental_bucket_activation",
    ("server.py", "_attachment_probe_scan", 3137, "replace"): "string_normalization",
    ("server.py", "_rm_verified_view_image", 4225, "Image.open"): "pillow_image_read",
    ("server.py", "hold", 5963, "replace"): "string_normalization",
    ("server.py", "boot", 6534, "replace"): "string_normalization",
    ("server.py", "dream", 6736, "bucket_mgr.touch"): "incidental_bucket_activation",
    ("server.py", "dream", 6762, "bucket_mgr.touch"): "incidental_bucket_activation",
