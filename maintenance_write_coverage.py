...
NON_PATH_CALL_ALLOWLIST: dict[tuple[str, str, int, str], str] = {
    ...
    ("server.py", "_days_since", 1755, "dt.replace"): "datetime_timezone",
    ("server.py", "format_active_matches", 2403, "bucket_mgr.touch"): "incidental_bucket_activation",
    ("server.py", "_breath_impl", 2726, "bucket_mgr.touch"): "incidental_bucket_activation",
    ("server.py", "_breath_impl", 2760, "bucket_mgr.touch"): "incidental_bucket_activation",
    ("server.py", "_breath_impl", 2826, "bucket_mgr.touch"): "incidental_bucket_activation",
    ("server.py", "_compose_breath_query_matches", 2520, "bucket_mgr.touch"): "incidental_bucket_activation",
    ("server.py", "_attachment_probe_scan", 3106, "replace"): "string_normalization",
    ("server.py", "_rm_verified_view_image", 4194, "Image.open"): "pillow_image_read",
    ("server.py", "hold", 5930, "replace"): "string_normalization",
    ("server.py", "boot", 6474, "replace"): "string_normalization",
    ("server.py", "dream", 6676, "bucket_mgr.touch"): "incidental_bucket_activation",
    ("server.py", "dream", 6702, "bucket_mgr.touch"): "incidental_bucket_activation",
